...
async def get_contacts(limit: int, offset: int, db: Session) -> Optional[List[Contact]]:
...
async def create_contact(body: ContactModel, db: Session) -> Optional[Contact]:
...
async def search_by_name(name: str, db: Session) -> Optional[Contact]:
...
async def search_by_last_name(last_name: str, db: Session) -> Optional[Contact]:
...
async def search_by_email(email: str, db: Session) -> Optional[Contact]:
...
async def search_by_phone(phone: int, db: Session) -> Optional[Contact]:
...
async def search_by_like_name(part_name: str, limit: int, offset: int, db: Session) -> Optional[List[Contact]]:
...
async def search_by_like_last_name(part_last_name: str, limit: int, offset: int, db: Session) -> Optional[List[Contact]]:
...
async def search_by_like_email(part_email: str, limit: int, offset: int, db: Session) -> Optional[List[Contact]]:
...
async def search_by_like_phone(part_phone: int, limit: int, offset: int, db: Session) -> Optional[List[Contact]]:
...
async def search_by_birthday_celebration_within_days(meantime: int, limit: int, offset: int, db: Session) -> Optional[List[Contact]]:
